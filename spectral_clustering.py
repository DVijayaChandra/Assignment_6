...
def adj_rand_ind(true_labels, pred_labels):
    ...
    # Calculate values for Rand Index formula
...
def spectral_clustering():
    ...
    plt.title('Eigenvalues Plot (smallest to largest)')
    plt.suptitle('Spectral Clustering')
